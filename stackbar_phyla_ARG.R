...
data <- read_excel('C:/Users/CFL/Desktop/UK/PhD/AMR/Archaea/ARG_align_prok/Archaea_ARG_nt_prok.xlsx', sheet = "Phyla")
...
extended_colors <- c("#E64B35","#FFD700","#229954","#4DBBD5", "#3C5488", "#F39B7F", 
                     "#8491B4", "#91D1C2", "#B09C85",
                     "#631879", "#EF8A47")  #
#绘制百分比条形图
p <- ggplot(long_data_percent, aes(x = factor(1), y = Percentage, fill = Category)) +
  ...
  labs(x = "ARG", y = "Percentage (%)", 
       title = "Phyla distribution by ARG",
       fill = "Phyla") +
  theme_minimal() +

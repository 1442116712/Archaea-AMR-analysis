...
p <- ggplot(long_data_percent, aes(x = factor(1), y = Percentage, fill = Category)) +
  ...
  scale_fill_manual(values = c("#F1A7A1", "#F4A582", "#F5D06D", "#A6D854", "#87C38F", "#94C5CC", "#00CED1", "#EED0C1", "#457B9D", "#8E44AD", "#D4A5C5", "#E6A8D7", "#C3B091", "#808000")) +
...
p <- ggplot(long_data_percent, aes(x = factor(1), y = Count, fill = Category)) +
  geom_bar(stat = "identity", position = "stack", width = 0.8) +
  scale_fill_manual(values = c("#F1A7A1", "#F4A582", "#F5D06D", "#A6D854", "#94C5CC", "#00CED1", "#EED0C1", "#457B9D", "#8E44AD", "#D4A5C5", "#E6A8D7", "#C3B091", "#808000")) +
